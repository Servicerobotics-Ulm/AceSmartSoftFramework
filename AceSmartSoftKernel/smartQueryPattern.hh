...
class SmartQueryClientInterface
{
  ...
  virtual Smart::StatusCode answer(const SmartACE::SmartMessageBlock*, size_t) = 0;
...
class SmartQueryServerInterface
{
  ...
  virtual Smart::StatusCode request(const SmartACE::SmartMessageBlock*, size_t id) = 0;
