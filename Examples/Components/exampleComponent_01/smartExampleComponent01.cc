...
int main (int argc, char *argv[])
{
  ...
  try {
    ...
    SmartACE::QueryServer<SmartACE::CommExampleTime,SmartACE::CommExampleTime> timeServant(component,"time-handler");
    TimeQueryHandler timeHandler(&timeServant);

    // Create sum servant and its handler
    SmartACE::QueryServer<SmartACE::CommExampleValues,SmartACE::CommExampleResult> calcServant(component,"calc-handler");
